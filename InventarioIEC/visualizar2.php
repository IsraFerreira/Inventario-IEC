...
//	echo "<td><a href='checkproduto.php?id=".$rid."nome=".$rnome."&rquantidade=".$rquantidade."&chamado=".$rchamado."' style=\"text-decoration: none; color:4f6b72;\" onMouseOver=\"this.style.textDecoration='underline';\" onMouseOut=\"this.style.textDecoration='none';\">$rnome</a></td>";
    echo "<td><a href='saidaproduto2.php?id=".$rid."&nome=".$rnome."&quantidade=".$rquantidade."&preco=".$rpreco."' style=\"text-decoration: none; color:4f6b72;\" onMouseOver=\"this.style.textDecoration='underline';\" onMouseOut=\"this.style.textDecoration='none';\">$rnome</a></td>";
...
//	}
	...
	echo "<td><a href='alterarproduto2.php?id=".$rid."&nome=".$rnome."&quantidade=".$rquantidade."'><img src='imagens/editar2.png'/></a></td>";
//	echo "<td><a href='apagar2.php?id=".$rid."&nome=".$rnome."&quantidade=".$rquantidade."'><img src='imagens/remover.png'/></a></td>";
	echo "</tr>";
...
<br>
<br>
<center><a href="entradasaida2.php"><input type="button" value="Entrada/Saída de Produto"></a>

<a href="visualizarlog2.php"><input type="button" value="Ultimas Mudanças"></a></center>
</form>
...
<br>
<center>
<a href="gerarplanilha22.php"><input type="button" value="Gerar EXCEL Completo"></a>
<?php
echo "<a href='gerarplanilhafiltro22.php?parametro=".$parametro."'><input type='button' value='Gerar EXCEL Filtro'></a>";
?>
</center>
<br>
<br>
