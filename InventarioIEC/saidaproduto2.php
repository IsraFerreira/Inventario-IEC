...
<form align="left" position-left="201px" action="inserirmudanca2.php" method="post"><h3> 
...
<input type="int" name="quantidadeacr" value="0" required/><br><br>

Chamado:
<input type="int" name="chamado2" value="Informe o chamado" required/><br><br>

Setor:
<input type="text" name="setor2" value="Informe o setor" required/><br><br>

Preco:
<input type="text" name="preco2" placeholder="preco" value="<?php echo $preco; ?>" readonly="true"> <br><br>
