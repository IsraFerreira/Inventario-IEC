...
//"SELECT * from produtosretirada where ID like ucase('%$parametro%') or nome like ucase('%$parametro%') or chamado like ucase('%$parametro%') or setor like ucase('%$parametro%') or ip like ucase('%$parametro%') or mensagem like ucase('%$parametro%') order by ID desc";
...
<a href="entradasaida2.php"><input type="button" value="Entrada/Saída de Produto"></a></center>
</form>
...
<br>
<center>
<a href="gerarplanilha23.php"><input type="button" value="Gerar EXCEL Completo"></a>
<?php
echo "<a href='gerarplanilhafiltro23.php?parametro=".$parametro."'><input type='button' value='Gerar EXCEL Filtro'></a>";
?>
