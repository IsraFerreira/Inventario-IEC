...
$conn = mysqli_connect($servidor, $usuario, $senha, $dbname);	
  ...
  $db = mysql_select_db('estoque');
    if (isset($entrar)) {
      ...
      $verifica = mysql_query("SELECT * FROM usuariostecnico WHERE login = '$login' AND senha = '$senha'") or die("erro ao selecionar");
